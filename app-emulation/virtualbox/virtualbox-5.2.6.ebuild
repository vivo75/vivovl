...
SLOT="0"
KEYWORDS="~amd64 ~x86"
IUSE="alsa debug doc headless java libressl lvm +module pam pax_kernel pulseaudio +opengl python +qt5 +sdk +udev vboxwebsrv vnc"

RDEPEND="!app-emulation/virtualbox-bin
	module? ( ~app-emulation/virtualbox-modules-${PV} )
	dev-libs/libIDL
